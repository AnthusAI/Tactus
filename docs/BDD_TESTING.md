...
See `examples/71-mocking-static.tac` and `examples/72-mocking-conditional.tac` for tool mocking examples, and `examples/80-dspy-predict-basic.tac` through `examples/87-dspy-history.tac` for DSPy module mocking examples.
