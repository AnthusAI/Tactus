    ...
    metadata: {
      ...
      agents: {
        analyzer: {
          ...
          model: 'gpt-4o',
          provider: 'openai',
          system_message: 'You are a helpful analyzer that processes user input and provides detailed analysis.',
        ...
        reviewer: {
          ...
          provider: 'bedrock',
          system_message: 'You are a reviewer that validates the analysis and provides feedback.',
          tools: ['validate', 'done'],
        },
      },
      toolsets: {},
    ...
    metadata: {
      ...
      agents: {
        researcher: {
          ...
          model: 'gpt-4o',
          provider: 'openai',
          system_message: 'You are a researcher that gathers information.',
        ...
        writer: {
          ...
          model: 'claude-3-5-sonnet-20241022',
          provider: 'bedrock',
          system_message: 'You are a writer that creates content based on research.',
        ...
        editor: {
          ...
          model: 'gpt-4o-mini',
          provider: 'openai',
          system_message: 'You are an editor that reviews and improves content.',
