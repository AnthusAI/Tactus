  ...
  args: {
    agents: {
      main: {
        ...
        model: 'gpt-4o',
        provider: 'openai',
        system_message: 'You are a helpful assistant that processes user requests and provides detailed responses.',
  ...
  args: {
    agents: {
      researcher: {
        ...
        model: 'gpt-4o',
        provider: 'openai',
        system_message: 'You are a researcher that gathers and analyzes information from various sources.',
      ...
      writer: {
        ...
        provider: 'bedrock',
        system_message: 'You are a professional writer that creates clear, engaging content based on research.',
      ...
      editor: {
        ...
        model: 'gpt-4o-mini',
        provider: 'openai',
        system_message: 'You are an editor that reviews content for clarity, grammar, and style.',
