...
class TactusLSPHandler:
        ...
        signatures = [
            {
                ...
                "parameters": [
                    ...
                    {"label": "config", "documentation": "Agent configuration: {provider, model, system_prompt, tools}"}
                ]
            },
            {
                ...
                "parameters": [
                    ...
                    {"label": "config", "documentation": "Parameter configuration: {type, required, default, description}"}
                ]
            },
            {
                ...
                "parameters": [
                    ...
                    {"label": "config", "documentation": "Output configuration: {type, required, description}"}
                ]
            }
        ]
    ...
    def _convert_to_diagnostic(self, message: ValidationMessage, severity_str: str) -> Optional[Dict[str, Any]]:
        """
