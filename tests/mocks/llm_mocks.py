...
class MockLLMProvider:
    ...
    async def mock_agent_run(self, user_input: str, deps: Any = None, message_history: List = None, output_type: type = None):
...
def create_mock_agent_patch(use_real_api: bool = False):
    ...
    async def patched_run(self, user_input: str, deps: Any = None, message_history: List = None, output_type: type = None):
        ...
        if mock_provider:
            return await mock_provider.mock_agent_run(user_input, deps, message_history, output_type)
        else:
