"""
Compare LLM output quality with a short Context pack budget.
"""
...
def main() -> None:
    print_section("Context Quality Demo (short pack)")
    ...
    wfo = "MFL"
    builder = _build_registry(pack_max_tokens=120, query=user_message, wfo=wfo)
    ...
    _print_story("short_context", assembled, pack_blocks, user_message)

    print_section("LLM response (short pack)")
