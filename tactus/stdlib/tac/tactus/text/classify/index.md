...
The `tactus.text.classify` module provides a comprehensive classification system with support for both LLM-based and fuzzy string matching approaches.
...
local FuzzyMatchClassifier = require("tactus.text.classify.fuzzy")
```
